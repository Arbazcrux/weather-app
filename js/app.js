...
$.ajax({
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&appid=3fbda9246b9b74cc191ff4559ebee9c1&units=metric",
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(forecast1 == "01d" || forecast1 == "01n"){
                ...
                document.querySelector(".icons-mon").src = "images/broken-cloud.png";
            }
                ...
                document.querySelector(".icons-mon").src = "https://www.dovora.com/resources/weather-icons/showcase/simplistic_showcase/mist.png";
                        ...
                        if(forecast2 == "01d" || forecast2 == "01n"){
                            ...
                            document.querySelector(".icons-tue").src = "images/broken-cloud.png";
                        }
                    ...
                    if(forecast3 == "01d" || forecast3 == "01n"){
                        ...
                        document.querySelector(".icons-wed").src = "images/broken-cloud.png";
                    }
                        ...
                        if(forecast4 == "01d" || forecast4 == "01n"){
                            ...
                            document.querySelector(".icons-thus").src = "images/broken-cloud.png";
                        }
                   ...
                   if(forecast5 == "01d" || forecast5 == "01n"){
                    ...
                    document.querySelector(".icons-fri").src = "images/broken-cloud.png";
                   }
